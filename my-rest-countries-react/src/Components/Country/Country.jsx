...
export default function Country({
  ...
  return (
    ...
    >
      ...
      <figure>
        <img
          className="object-cover w-96 rounded-lg h-[250px]"
          src={flags.png}
          alt="Shoes"
        />
      </figure>
      <div className="card-body">
        ...
        <div className="card-actions justify-center">
          <button onClick={handleAddedClick} className="btn bg-lime-500">
            Added
          </button>
          <button
            onClick={() => handleClickVisited(name.common)}
            className="btn bg-lime-500"
          >
            Visited
          </button>
          <button
            onClick={() => handleClickFlags(flags.png)}
            className="btn bg-lime-500"
          >
            Add flag
          </button>
